## The following Script Finds folders for Windows Update scheduled tasks and deletes them.
...
$logFile = "C:\Windows\Setup\Cogstate\Scripts\Logs\RemoveUpdateTasks_Log.txt"
