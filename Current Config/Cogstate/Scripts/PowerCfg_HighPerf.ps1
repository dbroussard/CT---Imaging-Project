## The following script sets up the Cogstate Device High Performance Power Configuration.

# Define Script Variables
$logFile = "C:\Windows\Cogstate\Scripts\Logs\Powercfg_Log.txt"

# Start transcript for detailed logging
Start-Transcript -Path $logFile -Append

try {
    ## High-Performance Power Configuration, Windows 11 Device
