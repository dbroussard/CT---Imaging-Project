...
<!--********************************************************************************************
Installation Notes
Property of Cogstate ltd
Author: David L. Broussard
Revision Date: 5/31/2024 11:27:00 CST
Notes: The following version will be used for the setup of devices for Clinical Trials
************************************************************************************************-->
:EndComment
setlocal

REM Setting up High Performance Power Plan
...
powercfg -setacvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c e73a048d-bf27-4f12-9731-8b2076e8891f 9a66d8d7-4ff7-4ef9-b5a2-5a326ca2a469 1
powercfg -setdcvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c e73a048d-bf27-4f12-9731-8b2076e8891f 9a66d8d7-4ff7-4ef9-b5a2-5a326ca2a469 1
powercfg -setacvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c e73a048d-bf27-4f12-9731-8b2076e8891f 8183ba9a-e910-48da-8769-14ae6dc1170a 5
powercfg -setdcvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c e73a048d-bf27-4f12-9731-8b2076e8891f 8183ba9a-e910-48da-8769-14ae6dc1170a 5
...
powercfg -setacvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c e73a048d-bf27-4f12-9731-8b2076e8891f f3c5027d-cd16-4930-aa6b-90db844a8f00 1
powercfg -setdcvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c e73a048d-bf27-4f12-9731-8b2076e8891f f3c5027d-cd16-4930-aa6b-90db844a8f00 1

REM Add Desktop Icons
xcopy "C:\Windows\Setup\Cogstate\Cogstate_eSource_Platform.lnk" "C:\Users\Cogstate\Desktop" /H
xcopy "C:\Windows\Setup\Cogstate\Cogstate_eSource_Platform.lnk" "C:\Users\Cogstate Admin\Desktop" /H
REM Remove Desktop Icons
del "C:\Users\Cogstate\Desktop\Google Chrome.lnk"
del "C:\Users\Cogstate Admin\Desktop\Google Chrome.lnk"
del "C:\Users\Public\Desktop\Google Chrome.lnk"		
del "C:\Users\Cogstate\Desktop\Microsoft Edge.lnk"
del "C:\Users\Cogstate Admin\Desktop\Microsoft Edge.lnk"

REM Applying Group Policy Settings 
xcopy "C:\Windows\Setup\Cogstate\Assets\grouppolicy" "C:\Windows\System32\groupPolicy" /E /H
REM Applying security and audit definitions
Secedit /configure /cfg "C:\Windows\Setup\Cogstate\Assets\Security.csv" /db defltbase.sdb /verbose
Auditpol /restore /file:"C:\Windows\Setup\Cogstate\Assets\Audit.ini"

REM Windows Update PowerShell scripts
powershell.exe -ExecutionPolicy Bypass -File "C:\Windows\Setup\Cogstate\Scripts\CheckService_WaaSMedicSvc.ps1"
powershell.exe -ExecutionPolicy Bypass -File "C:\Windows\Setup\Cogstate\Scripts\FindFile_WaaSMedic.ps1"
powershell.exe -ExecutionPolicy Bypass -File "C:\Windows\Setup\Cogstate\Scripts\Remove_WinUpdateTasks.ps1"
powershell.exe -ExecutionPolicy Bypass -File "C:\Windows\Setup\Cogstate\Scripts\SchdTask_RemoveWinUpdateTasks.ps1"

REM Firewall Setup PowerShell scripts
powershell.exe -ExecutionPolicy Bypass -File "C:\Windows\Setup\Cogstate\Scripts\Firewall_Setup.ps1"

REM Kiosk Mode Setup PowerShell scripts
powershell.exe -ExecutionPolicy Bypass -File "C:\Windows\Setup\Cogstate\Scripts\Setup_KioskMode.ps1"

REM Run the new Scheduled Task(s)
schtasks /run /tn "CheckService_WaaSMedicSvc"
schtasks /run /tn "CogstateKiosk"
...
if exist "C:\Program Files\Google\Chrome\Application\chrome.exe" (
	...
	if exist "C:\Program Files (x86)\Google\GoogleUpdater" (
	rmdir /s /q "C:\Program Files (x86)\Google\GoogleUpdater"
	)
) else (
    echo Google Chrome is not installed.
    set /p "confirm=Do you want to install Google Chrome now? (Y/N): "
    if /i "%confirm%" EQU "Y" (
        echo Installing Google Chrome...
        msiexec /i "C:\Windows\Setup\Cogstate\ChromeSetup.msi" /qn
		taskkill /f /im GoogleCrashHandler.exe
		taskkill /f /im GoogleCrashHandler64.exe
		takeown /f "C:\Program Files (x86)\Google\Update"
		rmdir /s /q "C:\Program Files (x86)\Google\Update"
		REM Check if installation was successful
		if %ERRORLEVEL% EQU 0 (
			echo Google Chrome installed successfully.
		) else (
			echo Error: Failed to install Google Chrome. Check %LOGFILE% for details.
			exit /b 1
    )
    ) else (
...
REM Rebooting the Comptuter after Validation 
Shutdown /r /t 0 